...
const dispatch= useDispatch();
  ...
  return (
    <div className="menu">
       <Link className= "bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 h-10 md:h-10" to="/places/add">Afegir Entrada</Link>
       <Link className= "text-white font-bold py-2 px-4 h-10 md:h-10 bg-orange-500 hover:bg-orange-700" to="/places/grid">Grid</Link>
       <Link className= "text-white font-bold py-2 px-4 h-10 md:h-10 bg-orange-500 hover:bg-orange-700" to="/places/list">Llista</Link>
       <Link className= "text-white font-bold py-2 px-4 h-10 md:h-10 bg-green-500 hover:bg-green-700" to="/places/marks">Marks</Link>
